...
struct InternalInstruction {
  ...
  // save native opcode: escapes + opcode + modrm extension
 ...
 // attempt to get the position of each operand in the instruction
 // WARNING: this is incorrect for some instructions
 uint8_t       operandPosition[X86_MAX_OPERANDS];
