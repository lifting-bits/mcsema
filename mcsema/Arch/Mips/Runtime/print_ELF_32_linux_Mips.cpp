...
int main(void) {
  ...
  printf("  pop DWORD PTR gs:[__mcsema_reg_state@NTPOFF + %u]\n", __builtin_offsetof(RegState, PC));

  // General purpose registers.
//  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], zero\n", __builtin_offsetof(RegState, ZERO));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], at\n", __builtin_offsetof(RegState, AT));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], v0\n", __builtin_offsetof(RegState, V0));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], v1\n", __builtin_offsetof(RegState, V1));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], a0\n", __builtin_offsetof(RegState, A0));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], a1\n", __builtin_offsetof(RegState, A1));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], a2\n", __builtin_offsetof(RegState, A2));

  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], a3\n", __builtin_offsetof(RegState, A3));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], t0\n", __builtin_offsetof(RegState, T0));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], t1\n", __builtin_offsetof(RegState, T1));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], t2\n", __builtin_offsetof(RegState, T2));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], t3\n", __builtin_offsetof(RegState, T3));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], t4\n", __builtin_offsetof(RegState, T4));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], t5\n", __builtin_offsetof(RegState, T5));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], t6\n", __builtin_offsetof(RegState, T6));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], t7\n", __builtin_offsetof(RegState, T7));

  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], s0\n", __builtin_offsetof(RegState, S0));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], s1\n", __builtin_offsetof(RegState, S1));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], s2\n", __builtin_offsetof(RegState, S2));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], s3\n", __builtin_offsetof(RegState, S3));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], s4\n", __builtin_offsetof(RegState, S4));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], s5\n", __builtin_offsetof(RegState, S5));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], s6\n", __builtin_offsetof(RegState, S6));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], s7\n", __builtin_offsetof(RegState, S7));

  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], t8\n", __builtin_offsetof(RegState, T8));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], t9\n", __builtin_offsetof(RegState, T9));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], k0\n", __builtin_offsetof(RegState, K0));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], k1\n", __builtin_offsetof(RegState, K1));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], gp\n", __builtin_offsetof(RegState, GP));
//  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], sp\n", __builtin_offsetof(RegState, SP));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], fp\n", __builtin_offsetof(RegState, FP));
  printf("  mov gs:[__mcsema_reg_state@NTPOFF + %u], ra\n", __builtin_offsetof(RegState, RA));
  ...
  printf("  sub DWORD PTR gs:[__mcsema_stack_mark@NTPOFF], sp\n");
