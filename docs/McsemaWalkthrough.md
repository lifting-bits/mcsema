...
If header files are available that declare these external functions, this defs file can be automatically generated using the [DEF file generation script](DEFFileGeneration.md)
