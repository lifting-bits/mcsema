...
if exist "%IDA_PATH%\idaq.exe" (
    ...
    %BIN_DESCEND_PATH%\bin_descend.exe -d -func-map=%STD_DEFS% -entry-symbol=_printdata -i=demo_test10.obj
)

%CFG_TO_BC_PATH%\cfg_to_bc.exe -i demo_test10.cfg -driver=demo10_entry,_printdata,0,return,C -o demo_test10.bc
