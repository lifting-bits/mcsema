...
%CFG_TO_BC_PATH%\cfg_to_bc.exe -mtriple=i386-pc-win32 -i demo_test2.cfg -driver=demo2_entry,start,raw,return,C -o demo_test2.bc
...
"%VCINSTALLDIR%\bin\cl.exe" /Zi /nologo demo_driver2.c demo_test2_mine.obj
demo_driver2.exe
