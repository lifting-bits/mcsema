...
if exist "%IDA_PATH%\idaq.exe" (
    ...
    %BIN_DESCEND_PATH%\bin_descend.exe -d -entry-symbol=_demo3 -i=demo_test3.obj
)

%CFG_TO_BC_PATH%\cfg_to_bc.exe -i demo_test3.cfg -driver=demo3_entry,_demo3,2,return,C -o demo_test3.bc
