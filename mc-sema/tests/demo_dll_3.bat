...
if exist "%IDA_PATH%\idaq.exe" (
    ...
    %PYTHON% %BIN_DESCEND_PATH%\bin_descend_wrapper.py -d -entry-symbol=StartServer -ignore-native-entry-points=true -i=demo_dll_3.dll -func-map="%STD_DEFS%"
) else (
...
REM Convert to LLVM
%CFG_TO_BC_PATH%\cfg_to_bc.exe -post-analysis=false -mtriple=i686-pc-win32 -i demo_dll_3.cfg -entrypoint=StartServer -o demo_dll_3.bc
clang -target i686-pc-win32 -O0 -m32 -c -o demo_dll_3_bc.obj demo_dll_3.bc
clang -target i686-pc-win32 -O0 -m32 -c -o demo_dll_3_asm.obj ..\..\drivers\PE_32_windows.asm
