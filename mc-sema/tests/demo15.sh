...
then
    ...
    ${BIN_DESCEND_PATH}/bin_descend_wrapper.py -march=x86 -func-map="demo15_map.txt" -entry-symbol=imstdcall -i=demo_test15.o >> /dev/null
else
...
${CFG_TO_BC_PATH}/cfg_to_bc -mtriple=i686-pc-linux-gnu -i demo_test15.cfg -entrypoint=imstdcall -o demo_test15.bc
