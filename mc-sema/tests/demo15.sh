...
${CFG_TO_BC_PATH}/cfg_to_bc -march=x86 -i demo_test15.cfg -driver=imcdecl,imcdecl,2,return,C -driver=imstdcall,imstdcall,2,return,E -driver=imfastcall,imfastcall,2,return,F -o demo_test15.bc
