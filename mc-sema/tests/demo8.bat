...
if exist "%IDA_PATH%\idaq.exe" (
    ...
    %BIN_DESCEND_PATH%\bin_descend.exe -d -entry-symbol=_doOp -i=demo_test8.obj
)

%CFG_TO_BC_PATH%\cfg_to_bc.exe -i demo_test8.cfg -driver=demo8_entry,_doOp,1,return,C -o demo_test8.bc
