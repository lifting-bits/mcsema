...
if exist "%IDA_PATH%\idaq.exe" (
    ...
    %BIN_DESCEND_PATH%\bin_descend.exe -d -func-map="%STD_DEFS%" -entry-symbol=_foo -i=demo_test5.obj
)

%CFG_TO_BC_PATH%\cfg_to_bc.exe -i demo_test5.cfg -driver=demo5_entry,_foo,1,return,C -o demo_test5.bc
