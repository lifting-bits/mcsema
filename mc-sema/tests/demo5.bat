...
%CFG_TO_BC_PATH%\cfg_to_bc.exe -mtriple=i386-pc-win32 -i demo_test5.cfg -driver=demo5_entry,_foo,1,return,C -o demo_test5.bc
...
"%VCINSTALLDIR%\bin\cl.exe" /Zi /nologo demo_driver5.c demo_test5_mine.obj
demo_driver5.exe
