...
then
    ...
    ${BIN_DESCEND_PATH}/bin_descend -march=x86 -d -entry-symbol=start -i=demo_test1.o
fi

${CFG_TO_BC_PATH}/cfg_to_bc -march=x86 -i demo_test1.cfg -driver=demo1_entry,start,raw,return,C -o demo_test1.bc
