...
${CFG_TO_BC_PATH}/cfg_to_bc -mtriple=x86_64-pc-linux-gnu -i demo_test2.cfg -entrypoint=start -o demo_test2.bc

clang-3.5 -O3 -m64 -o demo_driver2.exe demo_driver2.c ../../../drivers/ELF_64_linux.S demo_test2.bc
./demo_driver2.exe
