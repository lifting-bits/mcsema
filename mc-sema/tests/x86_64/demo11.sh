...
then
    ...
    ${BIN_DESCEND_PATH}/bin_descend_wrapper.py -march=x86-64 -func-map="demo11_map.txt" -entry-symbol=printdata -i=demo_test11.o >> /dev/null
else
    echo "Using bin_descend to recover CFG"
    ${BIN_DESCEND_PATH}/bin_descend -march=x86-64 -d -func-map="demo11_map.txt" -entry-symbol=printdata -i=demo_test11.o
fi

${CFG_TO_BC_PATH}/cfg_to_bc -march=x86-64 -i demo_test11.cfg -driver=demo11_entry,printdata,0,return,C -o demo_test11.bc
