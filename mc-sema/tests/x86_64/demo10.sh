...
${CFG_TO_BC_PATH}/cfg_to_bc -mtriple=x86_64-pc-linux-gnu -i demo_test10.cfg -driver=demo10_entry,printdata,0,return,C -o demo_test10.bc

${LLVM_PATH}/opt -O3 -o demo_test10_opt.bc demo_test10.bc
${LLVM_PATH}/llc -march=x86-64 -filetype=obj -o demo_test10_mine.o demo_test10_opt.bc
