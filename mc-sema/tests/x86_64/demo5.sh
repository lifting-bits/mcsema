...
${CFG_TO_BC_PATH}/cfg_to_bc -mtriple=x86_64-pc-linux-gnu -i demo_test5.cfg -entrypoint=foo -o demo_test5.bc
clang-3.5 -O3 -m64 -o demo_driver5.exe demo_driver5.c ../../../drivers/ELF_64_linux.S demo_test5.bc
./demo_driver5.exe
