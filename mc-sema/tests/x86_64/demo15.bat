...
if exist "%IDA_PATH%\idaq.exe" (
    ...
    %BIN_DESCEND_PATH%\bin_descend.exe -d -march=x86-64 -func-map=%STD_DEFS% -entry-symbol=imcdecl,imstdcall@8,@imfastcall@8 -i=demo_test15.obj
)

%CFG_TO_BC_PATH%\cfg_to_bc.exe -march=x86-64 -i demo_test15.cfg -driver=imcdecl,imcdecl,2,return,C -driver=imstdcall,imstdcall,2,return,E -driver=imfastcall,@imfastcall@8,2,return,F -o demo_test15.bc
