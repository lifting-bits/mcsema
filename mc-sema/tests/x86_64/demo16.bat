...
if exist "%IDA_PATH%\idaq.exe" (
    ...
    %BIN_DESCEND_PATH%\bin_descend_wrapper.py -march=x86-64 -d -func-map=demo16_defs.txt,%STD_DEFS% -entry-symbol=shiftit -i=demo_test16.obj
) else (
...
%CFG_TO_BC_PATH%\cfg_to_bc.exe -mtriple=x86_64-pc-win32 -i demo_test16.cfg -driver=shiftit,shiftit,2,return,C  -o demo_test16.bc
