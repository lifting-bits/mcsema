...
%CFG_TO_BC_PATH%\cfg_to_bc.exe -mtriple=i386-pc-win32 -i demo_test12.cfg -driver=demo12_entry,start,raw,return,C -o demo_test12.bc
...
"%VCINSTALLDIR%\bin\cl.exe" /Zi /nologo demo_driver12.c demo_test12_mine.obj
demo_driver12.exe
