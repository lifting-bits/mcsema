...
${CFG_TO_BC_PATH}/cfg_to_bc -mtriple=i686-pc-linux-gnu -i demo_test6.cfg -entrypoint=doWork -o demo_test6.bc
clang-3.5 -O3 -m32 -o demo_driver6.exe demo_driver6.c ../../drivers/ELF_32_linux.S demo_test6.bc
