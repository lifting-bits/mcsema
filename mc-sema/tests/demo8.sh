...
then
    ...
    ${BIN_DESCEND_PATH}/bin_descend_wrapper.py -entry-symbol=doOp -i=demo_test8.o >> /dev/null
else
    echo "Using bin_descend to recover CFG"
    ${BIN_DESCEND_PATH}/bin_descend -d -entry-symbol=doOp -i=demo_test8.o
fi

${CFG_TO_BC_PATH}/cfg_to_bc -i demo_test8.cfg -driver=demo8_entry,doOp,1,return,C -o demo_test8.bc
