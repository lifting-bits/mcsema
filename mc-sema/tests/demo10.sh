...
then
    ...
    ${BIN_DESCEND_PATH}/bin_descend_wrapper.py -func-map="demo10_map.txt" -entry-symbol=printdata -i=demo_test10.o >> /dev/null
else
    echo "Using bin_descend to recover CFG"
    ${BIN_DESCEND_PATH}/bin_descend -d -func-map="demo10_map.txt" -entry-symbol=printdata -i=demo_test10.o
fi

${CFG_TO_BC_PATH}/cfg_to_bc -i demo_test10.cfg -driver=demo10_entry,printdata,0,return,C -o demo_test10.bc
