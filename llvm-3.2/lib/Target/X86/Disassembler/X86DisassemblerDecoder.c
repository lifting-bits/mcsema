...
static int readOperands(struct InternalInstruction* insn) {
  ...
  for (index = 0; index < X86_MAX_OPERANDS; ++index) {
    insn->operandPosition[index] = insn->readerCursor - insn->startLocation;
...
int decodeInstruction(struct InternalInstruction* insn,
  ...
  {   
      ...
      case THREEBYTE_A6:
      case THREEBYTE_A7:
          insn->native_opcode[index] = insn->threeByteEscape;
          ++index;
          insn->native_opcode[index] = tbtable[insn->opcodeType];
          ++index;
          break;
      case TWOBYTE:
          insn->native_opcode[index] = insn->twoByteEscape;
          ++index;
          break;
      case ONEBYTE:
      default:
